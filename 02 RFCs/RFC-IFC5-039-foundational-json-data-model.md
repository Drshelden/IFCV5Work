<!-- rfc-form -->
📋 **[Take the feedback form for IFC5-039](PENDING — run create_rfc_forms_039_040.py)** — answer the open questions and leave comments directly.
<!-- rfc-nav -->
[📄 GitHub MD](https://github.com/Drshelden/IFCV5Work/blob/master/02%20RFCs/RFC-IFC5-039-foundational-json-data-model.md) · [📝 Google Doc](PENDING — run sync_to_gdrive.py) · [💬 View all discussions](https://github.com/Drshelden/IFCV5Work/discussions?discussions_q=label%3AIFC5-039) · [+ New discussion](https://github.com/Drshelden/IFCV5Work/discussions/new?category=-tier-1-foundational&title=%5BRFC+Feedback%5D+IFC5-039+%E2%80%94+&labels=IFC5-039) · [📋 Take the feedback form](PENDING — run create_rfc_forms_039_040.py)
