...
def build_github_md(forms_idx, drive_idx):
    lines = [
        ...
        "",
        "40 RFCs covering the major architectural decisions for IFC5. All are at **Idea** status — no decisions have been made yet. The [Decision Register](../01%20Decision%20Register/IFC5_Decision_Register.csv) is the authoritative status tracker. ⚗️ = prototype required before Committee Review.",
        "",
        "---",
        "",
    ]
...
def build_drive_md(forms_idx, drive_idx):
    lines = [
        ...
        "",
        "40 RFCs covering the major architectural decisions for IFC5. All are at Idea status — no decisions have been made yet. ⚗️ = prototype required before Committee Review.",
        "",
